            ...
            <div style="width:440px;border:1px solid #E7E7E7;padding:20px 0 20px 30px;border-radius:5px;margin-top:60px;background:#fff;">
                ...
                <form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <img id="verifyCode" src="${pageContext.request.contextPath}/UserServlet?method=getImg"/>
                        </div>
                        <script type="text/javascript">
                            $(function () {
                                ...
                                $("#verifyCode").click(function () {
                                    $("#verifyCode").attr("src","${pageContext.request.contextPath}/UserServlet?method=getImg&id="+Date.now())
                                });
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                ...
                                <label>
                                    <input type="checkbox" id="remeberMe" name="remeberMe"> 记住用户名
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <input type="submit" id="btn" width="100" value="登录" name="submit" border="0"
