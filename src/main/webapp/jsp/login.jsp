...
<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
		<%--判断记住我的cookie,记住我相关rememberCookie=on; lastUsername=bb; lastPassword=bb--%>
		<input type="text" class="form-control" id="username" name="username"
			   <c:if test="${cookie.rememberCookie.value == 'on'}">value="${cookie.lastUsername.value}"</c:if>
			    placeholder="请输入用户名">
    </div>
	 <div class="col-sm-4" id="messageSpan">${message}</div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" id="vrifyCode" placeholder="请输入验证码">
    </div>
    <div class="col-sm-3">
      ...
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="rememberMe"
				 <c:if test="${cookie.rememberCookie.value == 'on'}">checked="checked"</c:if>
		  > 记住用户名
        </label>
      </div>
    </div>
